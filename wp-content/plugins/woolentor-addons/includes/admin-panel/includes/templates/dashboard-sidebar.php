...
<div class="woolentor-admin-sidebar">
    ...
    <?php if( !is_plugin_active('woolentor-addons-pro/woolentor_addons_pro.php') ) :?>
        <div class="woolentor-pro-banner">
            <div class="woolentor-pro-banner-logo"><img src="<?php echo esc_url( WOOLENTOROPT_ASSETS.'/images/logo.png' ); ?>" alt="<?php echo esc_attr__('Woolentor Logo','woolentor'); ?>"></div>
    ...
    <div class="woolentor-rating">
        <div class="woolentor-rating-icon">
            <img src="<?php echo esc_url(WOOLENTOROPT_ASSETS.'/images/icons/rating.png'); ?>" alt="<?php echo esc_attr__('Rating icon','woolentor'); ?>">
        </div>
